...
import { faCircleXmark, faPlay, faPlus, faSquareCaretLeft } from '@fortawesome/free-solid-svg-icons';
...
const Modal = (props: ModalProps) => {
    ...
    return (
        <div className={`${props.hidden ? "hidden" : 0} flex justify-center  items-center fixed bg-black h-[100vh] w-[100vw] z-20 text-white overflow-hidden  `}>
            ...
            <FontAwesomeIcon icon={faSquareCaretLeft} className="absolute z-30 top-2 left-2 cursor-pointer " size='2x' onClick={closeModal}/>
                ...
                <div className='grid items-center'>
                    ...
                    <div className='flex items-center gap-5'> Nota: <Score score={props.data?.vote_average} /></div>
